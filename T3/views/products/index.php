              ...
              <div class="d-sm-flex align-items-center mb-4">
                <ul class="list-inline me-auto my-1">
                  <li class="list-inline-item">
                    ...
                    <a href="create" class="btn btn-primary"><i class="ph-duotone ph-plus"></i>Agregar Producto</a>
                  </li>
                </ul>
                      ...
                      <div class="card product-card">
                        <div class="card-img-top">
                          <a href="details/<?= $product->slug ?>">
                            <img src="<?= $product->cover ?>" alt="image" onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name=<?php echo urlencode($product->name); ?>';" class="img-prod img-fluid" style="height: 400px" />
